...
\begin{figure}[H]
    ...
    \caption{Comparison of chemical analysis measurements for each feedstock. FIXME: y-axis should be dry basis, not as-determined basis.}
...
For the chemical analysis data, the given dry basis values $P_d$ are converted to a dry ash-free basis $P_{daf}$ using Equation \ref{eq:chem-daf} where $P_{s.\,inorg.}$ is the structural inorganics and $P_{ns.\,inorg.}$ is the non-structural inorganics.
