...
\begin{figure}[H]
    ...
    \caption{Comparison of the experimental and batch reactor model yields. For each feedstock, model yields are the top bar and experimental yields are the bottom bar.}
